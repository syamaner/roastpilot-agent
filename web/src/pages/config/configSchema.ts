...
const ADVISOR_FIELDS: ConfigFieldDef[] = [
  ...
  },
  {
    ...
    hint:           "Advisor request timeout (seconds), for tooling that reads it. NOT the control-loop bound — the controller cuts an advisory call at its own advisory_timeout_seconds (5.0 s, D151).",
    type:           "number",
    unit:           "s",
