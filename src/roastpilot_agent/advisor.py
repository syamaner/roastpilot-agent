...
_C7_DTR_PACE_SECTION = (
    ...
    "ceiling is 'close' or 'approaching'. The ceiling still forces the drop "
    "the instant the computed gap reaches zero or goes negative, exactly as "
    "the joint-objective section teaches, regardless of where DTR or "
    "temperature stand - but only the computed number decides that, never an "
    "impression.\n"
...
_C8_PACE_BOTTOM_EDGE_AND_FAN_SECTION = (
    ...
    "or 'approaching'. The ceiling still forces the drop the instant the "
    "computed gap reaches zero or goes negative, regardless of where DTR or "
    "temperature stand - but only the computed number decides that, never "
    "an impression.\n"
    "\n"
